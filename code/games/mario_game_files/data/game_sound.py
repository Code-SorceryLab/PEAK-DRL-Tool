...
# at top
import os
NO_AUDIO = os.getenv("MARIO_NO_AUDIO", "1") == "1"

# wherever mixer is initialized / sounds are loaded
if not NO_AUDIO:
    pg.mixer.init()
    # load sounds as before
else:
    class _NullSound:
        def play(self, *a, **k): pass
        def set_volume(self, *a, **k): pass
    # return dict of name->_NullSound() instead of real sounds
